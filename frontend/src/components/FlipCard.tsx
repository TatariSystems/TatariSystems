...
const FlipCard: React.FC<FlipCardProps> = ({ member, index }) => {
  return (
    ...
    >
      <div className="relative w-full h-full bg-black/20 backdrop-blur-sm rounded-2xl p-6 flex flex-col items-center justify-center hover:bg-black/30 transition-all duration-300">
        <div className="mb-6">
          {member.img ? (
            <img
